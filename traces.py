...
COLOR_ELLIPSE     = '#FF4444'   # red      — polarization ellipse in 3D
COLOR_SPHERE      = '#A8DADC'   # pale blue — atom cloud
COLOR_LAB_AXES    = '#8888A8'   # blue-gray — x, y, z reference lines
...
COLOR_LAB_AXES_TEXT = '#8888A8'   # blue-gray — axis labels
